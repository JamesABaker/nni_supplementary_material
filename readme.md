...
1. Run the database builder scripts using  `python topdb_to_table(fasta).py` and `python Uniprot_to_table.py`.

2. Move the files you want to produce tables and figures  into the `tables_and_figures` folder.

3. Run the respective scripts. Some may require moving vectors and numbers outputted into a graph producing software like Excel.
