...
for file in list_of_files:
    ...
    for type_of_protein in type_of_proteins:
        ...
        # For Figure 1 Uncomment these lines to get the total values of each amino acid printed in a table.
        print "\nFIGURE 1"
        total_amino_acids = 0
        ...
        #P-value for a KW test. This may run into errors for UniArch. If you are only interested in replicating the data for tables 2 and 3, see the table 2.py scripts."
        '''
