        ...
        for i in range(int(max_sequence_length)-1):
            ...
            for n in single:
                if n[i] == "":
                    ...
                    values_for_single.append(int(n[i]))
            ...
            for y in multi:
                ...
                if y[i] == "":
                    ...
                    values_for_multi.append(int(y[i]))

            p_value_at_this_position = scipy.stats.ttest_ind(values_for_single, values_for_multi)
